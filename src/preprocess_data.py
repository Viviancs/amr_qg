...
def main():
    ...
    trainData = Dataset(sequences['train'], graphs['train'], opt.batch_size, answer=opt.answer, feature=opt.feature, node_feature=opt.node_feature, copy=opt.copy)
    validData = Dataset(sequences['valid'], graphs['valid'], opt.batch_size, answer=opt.answer, feature=opt.feature, node_feature=opt.node_feature, copy=opt.copy)
