...
python train.py \
       ...
       -checkpoint "/data1/lkx/cs/qg/model/classifier/classifier_gl_fuse_cls_76.34502_accuracy.chkpt" \
       -epoch 30 \
       ...
       -gpus 1 \
       -save_mode best -save_model "/data1/lkx/cs/qg/model/generator/generator" \
